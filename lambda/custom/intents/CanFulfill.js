...
module.exports = {
  check: function(event) {
    ...
    const universalIntents = ['HighScoreIntent', 'AMAZON.RepeatIntent', 'AMAZON.FallbackIntent',
      ...
      'CrapsBetIntent', 'HardwaysBetIntent', 'HardBetIntent', 'HornBetIntent', 'SevenBetIntent',
      'ComBetIntent', 'DontComeBetIntent', 'PlaceBetIntent', 'YoBetIntent', 'RemoveBetIntent',
      'RollIntent', 'ResetIntent'];
